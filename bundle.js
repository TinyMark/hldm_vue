...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(7), __webpack_require__(20).setImmediate))
...
exports.default = {
    data: function data() {
        return {
            imgList: [],
            firList: [{ name: "新增连载" }, { name: "新增完结" }, { name: "连载推送" }, { name: "推荐完结" }],
            secList: [],
            selected: 1
        };
    },
    created: function created() {
        ...
        this.$http.get(this.api.getlunbo).then(function (res) {
            console.log(res);
            _this.imgList = res.data;
        });
        this.$http.get(this.api.gethometab + "/" + this.selected).then(function (res) {
            console.log(res);
            _this.secList = res.data;
        });
    },
...
exports.default = {
    ...
    created: function created() {
        ...
        this.$store.state.title = "连载动漫";
        this.$http.get(this.api.getlianzai).then(function (res) {
            console.log(res);
...
exports.default = {
    ...
    created: function created() {
        ...
        this.$store.state.title = "专题列表";
        this.$http.get(this.api.getzhuanti).then(function (res) {
            console.log(res);
            _this.showList = res.data;
        });
    }
...
var _aside = __webpack_require__(69);
...
exports.default = {
    data: function data() {
        return {
            asideList: [{ text: "连载动漫", path: "/lianzai" }, { text: "专题列表", path: "/zhuanti" }, { text: "关于", path: "/" }]
        };
    },

    computed: {
        asideShow: function asideShow() {
    ...
    methods: {
        hideAside: function hideAside() {
            ...
            var rootDiv = this.$parent.$el;
            rootDiv.parentNode.style = "overflow-y:auto";
        }
    }
};
...
exports.default = {
    methods: {
        moreList: function moreList() {
            ...
            var rootDiv = this.$parent.$el;
            rootDiv.parentNode.style = "overflow-y:hidden";
        }
    },
    computed: {
...
var _lianzai = __webpack_require__(57);

var _lianzai2 = _interopRequireDefault(_lianzai);

var _zhuanti = __webpack_require__(61);

var _zhuanti2 = _interopRequireDefault(_zhuanti);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
    routes: [{ path: "/", redirect: "/index" }, { path: "/index", component: _index2.default }, { path: "/lianzai", component: _lianzai2.default }, { path: "/zhuanti", component: _zhuanti2.default }]
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_496599fa_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(56);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_496599fa_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-496599fa", Component.options)
  } else {
    hotAPI.reload("data-v-496599fa", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("fe20cd28", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-496599fa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-496599fa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\nsection .mint-swipe {\n  height: 120px;\n  position: relative;\n}\nsection .mint-swipe img {\n  width: 100%;\n}\nsection .mint-swipe span {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  padding-left: 30px;\n  display: block;\n  width: 100%;\n  line-height: 40px;\n  color: #fff;\n  font-size: 14px;\n  background-color: rgba(0, 0, 0, 0.3);\n}\nsection .mint-swipe .mint-swipe-indicators {\n  right: 0;\n  left: auto;\n}\nsection .mint-navbar .mint-tab-item.is-selected {\n  border-bottom: 3px solid #e92322;\n  color: #e92322;\n}\nsection .mint-navbar .mint-tab-item .mint-tab-item-label {\n  font-size: 14px;\n}\nsection .mint-tab-container {\n  margin-top: 3px;\n}\nsection .mint-tab-container .items {\n  display: block;\n  width: 46%;\n  float: left;\n  margin: 2%;\n  box-shadow: 0 0 10px #888888;\n  position: relative;\n}\nsection .mint-tab-container .items img {\n  width: 100%;\n  display: block;\n}\nsection .mint-tab-container .items span {\n  position: absolute;\n  bottom: 0;\n  display: block;\n  color: #fff;\n  width: 100%;\n  line-height: 36px;\n  text-align: center;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n", ""]);
  ...
  return _c(
    ...
    [
      _c(
        "mt-swipe",
        { attrs: { auto: 4000 } },
        _vm._l(_vm.imgList, function(v, i) {
          return _c("mt-swipe-item", { key: i, attrs: { src: v.url } }, [
            _c("img", { attrs: { src: v.img, alt: v.title } }),
            _vm._v(" "),
      ...
      _c(
        ...
        _vm._l(_vm.firList, function(v, i) {
          return _c("mt-tab-item", { key: i, attrs: { id: i + 1 } }, [
      ...
      _c(
        ...
        [
          _c(
            ...
            _vm._l(_vm.secList, function(v, i) {
              return _c(
                "a",
                { key: i, staticClass: "items", attrs: { src: v.url } },
                [
                  _c("img", { attrs: { src: v.img, alt: v.name } }),
                  _vm._v(" "),
                  _c("span", [_vm._v(_vm._s(v.update))])
                ]
              )
            })
          )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-496599fa", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_29bfa1a0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_lianzai_vue__ = __webpack_require__(60);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-29bfa1a0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_lianzai_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_29bfa1a0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_lianzai_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\pages\\lianzai.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-29bfa1a0", Component.options)
  } else {
    hotAPI.reload("data-v-29bfa1a0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("c90b4008", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-29bfa1a0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./lianzai.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-29bfa1a0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./lianzai.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\nul li[data-v-29bfa1a0] {\n  padding: 10px 10px 10px 10px;\n  border-bottom: 1px solid #ccc;\n}\nul li a[data-v-29bfa1a0] {\n  display: block;\n}\nul li a .leftSide[data-v-29bfa1a0] {\n  width: 30%;\n  display: table-cell;\n}\nul li a .leftSide img[data-v-29bfa1a0] {\n  display: block;\n  width: 100%;\n}\nul li a .rightSide[data-v-29bfa1a0] {\n  display: table-cell;\n  vertical-align: top;\n  padding-left: 10px;\n}\nul li a .rightSide h4[data-v-29bfa1a0] {\n  margin: 5px 0;\n}\nul li a .rightSide p[data-v-29bfa1a0] {\n  margin: 5px 0;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("section", [
    _c(
      "ul",
      _vm._l(_vm.showList, function(v, i) {
        return _c("li", { key: i }, [
          _c("a", { attrs: { href: "javascript:void(0)" } }, [
            _c("div", { staticClass: "leftSide" }, [
              _c("img", { attrs: { src: v.img } })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "rightSide" }, [
              _c("h4", [_vm._v(_vm._s(v.name))]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(v.episode))]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(v.updateTime))]),
              _vm._v(" "),
              _c("p", [_vm._v("下载次数：" + _vm._s(v.downloadCount))])
            ])
          ])
        ])
      })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-29bfa1a0", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e82a891_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_zhuanti_vue__ = __webpack_require__(64);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4e82a891"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_zhuanti_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e82a891_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_zhuanti_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\pages\\zhuanti.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4e82a891", Component.options)
  } else {
    hotAPI.reload("data-v-4e82a891", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("044d71ca", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4e82a891\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./zhuanti.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4e82a891\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./zhuanti.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\nul li[data-v-4e82a891] {\n  border-bottom: 1px solid #ccc;\n  margin: 10px;\n}\nul li a[data-v-4e82a891] {\n  line-height: 2;\n}\nul li a img[data-v-4e82a891] {\n  width: 100%;\n  display: block;\n}\nul li a span[data-v-4e82a891] {\n  display: block;\n  padding-left: 10px;\n  font-size: 14px;\n  color: #666;\n}\n", ""]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4e82a891", esExports)
  }
}
...
var domain = 'http://119.28.98.182:8888/api';

exports.default = {
    getlunbo: domain + '/getlunbo',
    gethometab: domain + '/gethometab',
    getlianzai: domain + '/getlianzai',
    getzhuanti: domain + '/gettopics'
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_38cab9c1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(77);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("2abaecbc", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-38cab9c1\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-38cab9c1\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_aside_vue__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4cd9b277_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_aside_vue__ = __webpack_require__(72);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4cd9b277_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_aside_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("1b83365b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4cd9b277\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./aside.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4cd9b277\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./aside.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("div", { staticClass: "aside" }, [
    _c("div", { class: { leftSide: true, show: _vm.asideShow } }, [
      _vm._m(0),
      _vm._v(" "),
      _c(
        "ul",
        _vm._l(_vm.asideList, function(v, i) {
          return _c(
            "li",
            { key: i, on: { click: _vm.hideAside } },
            [
              _c("router-link", { attrs: { to: v.path } }, [
    ...
    _vm._v(" "),
    _c("div", {
      class: { mask: true, show: _vm.asideShow },
      on: { click: _vm.hideAside }
    })
  ])
}
var staticRenderFns = [
  function() {
    ...
    return _c("div", [
      _c("img", {
        attrs: { src: "http://119.28.98.182:8888/logo.png", alt: "" }
      })
    ])
  }
]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b5967644_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_header_vue__ = __webpack_require__(76);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("33bbfdf9", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5967644\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5967644\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/less-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("mt-button", {
        attrs: { slot: "left", icon: "more" },
        on: { click: _vm.moreList },
        slot: "left"
      }),
      _vm._v(" "),
      _c("mt-button", {
...
var render = function() {
  ...
  return _c(
    "div",
    [_c("vAside"), _vm._v(" "), _c("vHeader"), _vm._v(" "), _c("router-view")],
    1
  )
}
var staticRenderFns = []
